...
{
    [TestFixture]
    public class CreateProjectStreamTestFixture
    {
        ...
        private static Project activeProject = new Project("existing", activeUser.Username) { Status = Status.Active };
        private static Project cancelledProject = new Project("cancelled", activeUser.Username) { Status = Status.Cancelled };
        private static Project completedProject = new Project("completed", activeUser.Username) { Status = Status.Complete };
        ...
        public void AddStreamToCancelledProjectThrowsException()
        {
            ...
            Assert.That(() => projectManager.AddProjectStream(cancelledProject.Name, newProjectStream, activeUser.Username), Throws.ArgumentException.With.Message.EqualTo(exceptionMessage));
        }
